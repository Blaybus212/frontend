...
import TextInput from '@/app/_components/onboarding/TextInput';
import { AI_ANSWER_EXAMPLE_LIST, CATEGORY_LIST, LEVEL_LIST, PERSONA_LIST, SPECIALIZED_LIST, THEME_LIST } from '@/app/_constants/onboarding';
import { useOnboarding } from '@/app/_hooks/useOnboarding';
...
export default function OnboardingPage() {
  const { step, formData, updateData, updateListData, nextStep, prevStep } = useOnboarding(4);
